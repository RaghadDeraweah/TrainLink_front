...
import 'package:untitled4/projwithlikes.dart';
...
class stup extends StatefulWidget {
    late Map<String,dynamic> stuinfo={};
    late String ID;
  stup(String ID,Map<String,dynamic> stuinfo){
    super.key;
...
class _MenuState extends State<stup> {
  @override
                    ...
                    child: Row(
                      ...
                      children: [
                        MaterialButton(
                          onPressed: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => pc(widget.stuinfo,widget.ID)));
