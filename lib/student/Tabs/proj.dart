...
class proj extends StatefulWidget {
  ...
  proj(Map<String,dynamic> stuinfo){super.key;
...
class _projectState extends State<proj> {
          ...
          onPressed: () {
           ...
           // if(widget.fromstu){
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => HomePost(stuinfo:widget.stuinfo,
                onDataRefresh: (){
                  fetchData().then((_) {
                  setState(() {
                    isDataReady=true;
                ...
                delegate: SliverChildBuilderDelegate(
                  (context, index) {
                   return Row(
                    ...
                    icon: Icon(Icons.favorite_outline_sharp,color: Colors.red,)
                    ),
                    posts[index]['likes']==[]
